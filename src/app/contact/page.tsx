      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Have questions about our products or custom orders? We love to hear from you.
            </motion.p>
          </div>
            ...
            >
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  {[
                    { name: 'Instagram', icon: '📸', url: 'https://instagram.com/ambiace' },
                    { name: 'Twitter', icon: '🐦', url: 'https://twitter.com/ambiace' },
                    { name: 'Pinterest', icon: '📌', url: 'https://pinterest.com/ambiace' },
                  ].map((social) => (
                    <a
                      key={social.name}
                      href={social.url}
